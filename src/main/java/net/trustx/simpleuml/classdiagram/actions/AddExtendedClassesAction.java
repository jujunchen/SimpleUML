   ...
   extends AddClassesAction
 {
   ...
   public AddExtendedClassesAction(PsiClassComponent psiClassComponent) {
     super(((ClassDiagramComponent)psiClassComponent.getDiagramPane()).getProject(), "Extended Classes");
   ...
   public void executeCommand(HashMap commandProperties, boolean first, boolean last) {
     ...
     PsiJavaCodeReferenceElement[] psiReferenceElements = UMLUtils.getReferenceElements(psiClass.getExtendsList());
