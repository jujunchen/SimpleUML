   ...
   extends JPanel
 {
   ...
   public PsiFieldComponent(ClassDiagramComponent classDiagramComponent, PsiClassComponent psiClassComponent, PsiField psiField) {
     setOpaque(false);
     setLayout(new BoxLayout(this, 0));

     this.accessLabel = new UMLLabel(UMLUtils.getUMLModifierString(psiField.getModifierList(), classDiagramComponent.getDiagramSettings().isLongModifier()));
     ...
     EditorHelper.initQuickSourceSupport(classDiagramComponent.getDiagramSettings().getQuickSourceLinkColor(), classDiagramComponent.getProject(), (JComponent)psiClassComponent, this.fieldNamelabel, psiField.getNameIdentifier(), this.underscored, false, false);
     ...
     this.typeComponent = new PsiTypeComponent(classDiagramComponent, (JComponent)psiClassComponent, psiField.getType(), font, false, true, true);
