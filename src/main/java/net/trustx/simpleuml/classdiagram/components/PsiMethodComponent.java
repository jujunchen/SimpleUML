   ...
   extends JPanel
 {
   ...
   public PsiMethodComponent(PsiClassComponent psiClassComponent, ClassDiagramComponent classDiagramComponent, PsiMethod psiMethod) {
     setOpaque(false);
     setLayout(new BoxLayout(this, 0));

     this.accessLabel = new UMLLabel(UMLUtils.getUMLModifierString(psiMethod.getModifierList(), classDiagramComponent.getDiagramSettings().isLongModifier()));

     Font font = classDiagramComponent.getDiagramSettings().getDiagramFont();
     ...
     EditorHelper.initQuickSourceSupport(classDiagramComponent.getDiagramSettings().getQuickSourceLinkColor(), classDiagramComponent.getProject(), (JComponent)psiClassComponent, this.methodNamelabel, psiMethod.getNameIdentifier(), this.underscored, false, false);
     ...
     boolean showParameters = classDiagramComponent.getDiagramSettings().isShowParameters();
     ...
     for (int i = 0; i < psiParameters.length; i++) {
       ...
       EditorHelper.initQuickSourceSupport(classDiagramComponent.getDiagramSettings().getQuickSourceLinkColor(), classDiagramComponent.getProject(), (JComponent)psiClassComponent, paramNameLabel, psiParameter.getNameIdentifier(), this.underscored, false, false);
       ...
       PsiTypeComponent typeComponent = new PsiTypeComponent(classDiagramComponent, (JComponent)psiClassComponent, psiParameter.getType(), font, this.underscored, true, showParameters);
     ...
     PsiTypeComponent psiTypeComponent = new PsiTypeComponent(classDiagramComponent, (JComponent)psiClassComponent, psiMethod.getReturnType(), font, false, true, true);
