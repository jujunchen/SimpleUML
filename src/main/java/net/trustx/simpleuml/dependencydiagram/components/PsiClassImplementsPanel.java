 ...
 public class PsiClassImplementsPanel
   extends JPanel
 {
   public PsiClassImplementsPanel(DependencyDiagramComponent dependencyDiagramComponent, PsiDependencyComponent psiClassComponent) {
     ...
     if (elements.length > 0) {
       ...
       Font normalFont = getFont(dependencyDiagramComponent, psiClass);
       ...
       for (int i = 0; i < elements.length; i++) {
         ...
         if (interfaceCount == 0) {
           ...
           {
             PsiTypeComponent scc = new PsiTypeComponent(dependencyDiagramComponent, psiClassComponent, extendedClass, normalFont, false, true, true);
             if (ds.getImplementsBehaviour() == 1) {
   ...
   private void addExtendsImplementsClassname(PsiClass psiClass, PsiDependencyComponent psiClassComponent, PsiTypeComponent scc) {
   ...
   private Font getFont(DependencyDiagramComponent dependencyDiagramComponent, PsiClass psiClass) {
