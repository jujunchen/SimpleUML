 ...
 public class DisplaySelfCallReturn
   extends DisplaySelfLink
 {
   ...
   DisplaySelfCallReturn(int callNumber, String name, DisplayObjectInfo from, DisplayObjectInfo to, int seq, String comment, boolean showComment) {
